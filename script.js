...
faqItems.forEach(item => {
    ...
    function toggleVideo(event) {
      ...
      if (video.paused) {
        ...
        video.play();
        playButton.style.display = "none";  // Hide play button while playing
      } else {
        video.pause();
        video.style.display = "none";  // Hide the video on pause
        playButton.style.display = "block";  // Show play button on pause
      }
    }
